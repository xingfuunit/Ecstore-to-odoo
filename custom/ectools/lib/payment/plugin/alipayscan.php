...
/**
 * alipay担保交易支付网关（国内）  扫码支付
 * @auther shopex ecstore dev dev@shopex.cn
 * @version 0.1
 * @package ectools.lib.payment.plugin
 */
final class ectools_payment_plugin_alipayscan extends ectools_payment_app implements ectools_interface_payment_app {

	/**
	 * @var string 支付方式名称
	 */
    public $name = '支付宝支付扫码支付';
    /**
     * @var string 支付方式接口名称
     */
    public $app_name = '支付宝支付扫码支付接口';
     /**
     * @var string 支付方式key
     */
    public $app_key = 'alipayscan';
	/**
	 * @var string 中心化统一的key
	 */
	public $app_rpc_key = 'alipayscan';
	/**
	 * @var string 统一显示的名称
	 */
    public $display_name = '支付宝扫码支付';
    /**
	 * @var string 货币名称
	 */
    public $curname = 'CNY';
    ...
    public function __construct($app){
		...
		$this->notify_url = kernel::openapi_url('openapi.ectools_payment/parse/' . $this->app->app_id . '/ectools_payment_plugin_alipayscan_server', 'callback');
		...
		$this->callback_url = kernel::openapi_url('openapi.ectools_payment/parse/' . $this->app->app_id . '/ectools_payment_plugin_alipayscan', 'callback');
