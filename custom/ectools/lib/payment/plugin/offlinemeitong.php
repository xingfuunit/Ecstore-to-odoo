 ...
 */
final class ectools_payment_plugin_offlinemeitong extends ectools_payment_app implements ectools_interface_payment_app {
	/**
	 * @var string 支付方式名称
	 */
	public $name = '货到付款-美通卡';
	/**
     * @var string 支付方式接口名称
     */
    public $app_name = '货到付款-美通卡接口';
    /**
     * @var string 支付方式key
     */
    public $app_key = 'offlinemeitong';
	/**
	 * @var string 中心化统一的key
	 */
	public $app_rpc_key = 'offlinemeitong';
	/**
	 * @var string 统一显示的名称
	 */
    public $display_name = '货到付款-美通卡';
    /**
	 * @var string 货币名称
	 */
    public $curname = 'CNY';
