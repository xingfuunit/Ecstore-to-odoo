...
'system.money.decimals'=>array('type'=>SET_T_ENUM,'default'=>5,'desc'=>app::get('b2c')->_('订单金额显示位数'),'options'=>array(0=>app::get('b2c')->_('无小数位'),1=>app::get('b2c')->_('1位小数'),2=>app::get('b2c')->_('2位小数'),3=>app::get('b2c')->_('3位小数'),4=>app::get('b2c')->_('4位小数'),5=>app::get('b2c')->_('5位小数'))),
