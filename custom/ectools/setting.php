...
$setting = array(
'site.decimal_digit.count'=>array('type'=>SET_T_ENUM,'default'=>5,'desc'=>app::get('ectools')->_('金额运算精度保留位数'),'options'=>array(0=>app::get('ectools')->_('整数取整'),1=>app::get('ectools')->_('取整到1位小数'),2=>app::get('ectools')->_('取整到2位小数'),3=>app::get('ectools')->_('取整到3位小数'),4=>app::get('ectools')->_('取整到4位小数'),5=>app::get('ectools')->_('取整到5位小数'))),//WZP
...
'site.decimal_digit.display'=>array('type'=>SET_T_ENUM,'default'=>5,'desc'=>app::get('ectools')->_('金额显示保留位数'),'options'=>array(0=>app::get('ectools')->_('整数取整'),1=>app::get('ectools')->_('取整到1位小数'),2=>app::get('ectools')->_('取整到2位小数'),3=>app::get('ectools')->_('取整到3位小数'),4=>app::get('ectools')->_('取整到4位小数'),5=>app::get('ectools')->_('取整到5位小数'))),//WZP
