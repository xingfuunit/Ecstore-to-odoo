...
class ecstoreappabcwap_ctl_site_request extends site_controller 
{
    /*unionpay conf*/
    ...
    {
		$this->callback_url = kernel::openapi_url('openapi.ectools_payment/parse/' . $this->app->app_id . '/ecstoreappabcwap_payment_plugin_ecstoreappabcwap', 'callback');
