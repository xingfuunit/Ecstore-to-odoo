...
function widget_groupactivity(&$setting,&$smarty){
    ...
    $data['info'] = $goodsInfo;
    $filter['goodsNum']= 1;//单商品团购
    //获取name/category/picl/picm/pics/marketprice/saleprice/memberPrice/discount/intro/link
    $getgoodsObject = kernel::single('groupactivity_mdl_getgoodsdata');
    $data['goodsdata'] = $getgoodsObject->get_goods_data($filter);
