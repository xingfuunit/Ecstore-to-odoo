...
class b2c_ctl_wap_product extends wap_frontpage{
    ...
    public function index() {
        ...
        //获取商品简介
        // $aGoods_list = $goodsModel->getList("intro,wapintro",array('goods_id'=>$productId));
        ...
        $aGoods = $aGoodsList[0];
        $this->pagedata['wx_img_id'] = $aGoods['wx_image_id'];
...
#        }
        ...
        if(in_array('product-index', $this->weixin_share_page)){
            ...
            $this->pagedata['weixin']['imgUrl'] = base_storager::image_path($this->pagedata['page_product_basic']['wx_image_id']);
    ...
    function _get_product_basic($productId,$aGoods,$siteMember){
        ...
        $productBasic['wapintro'] = $aGoods['wapintro'];
