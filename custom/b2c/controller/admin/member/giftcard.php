...
class b2c_ctl_admin_member_giftcard extends desktop_controller{
 ...
 /*       if(app::get('dzg')->getConf('version_id') != 3){
        ...
        if($_GET['action'] == 'export') $this->_end_message = '导出兑换卡';
            $this->finder('b2c_mdl_member_giftcard',array(
            'title'=>app::get('b2c')->_('兑换卡列表'),
            //'use_buildin_export'=>true,
            'use_buildin_recycle' => false,
            'use_buildin_filter'=>true,
            'actions'=>array(
                array('label'=>app::get('b2c')->_('作废'),'confirm'=>app::get('b2c')->_('确定作废选定兑换卡？作废后状态不可恢复'),'submit'=>'index.php?app=b2c&ctl=admin_member_giftcard&act=giftcard_invalid'),
            )
