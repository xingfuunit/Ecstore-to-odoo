    ...
    function setting(){
     ...
     function getOptions(){
        return array(
            ...
            'isssl'=>array('label'=>app::get('desktop')->_('ssl连接'),'type'=>'radio','options'=>array('1'=>app::get('desktop')->_("是"),'0'=>app::get('desktop')->_("否")),'value'=>$this->app->getConf('email.config.isssl')?$this->app->getConf('email.config.isssl'):"0"),
        );
    }
